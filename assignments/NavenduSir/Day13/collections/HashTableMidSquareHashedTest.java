...
class HashTableMidSquareHashedTest {

	HashTableMidSquareHashed ht;

	@BeforeEach
	void setUp() throws Exception {
		ht = new HashTableMidSquareHashed(10);
	}
	...
	void testAdd3() {
		...
		assertTrue(ht.add(7));
		assertTrue(ht.add(8));
		assertFalse(ht.add(9)); // collision not resolved
		assertTrue(ht.add(10));
		assertFalse(ht.add(11)); // collision not resolved
		assertFalse(ht.add(12));// collision not resolved
	}
